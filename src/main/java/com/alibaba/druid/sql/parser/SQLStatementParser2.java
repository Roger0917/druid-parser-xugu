...
public class SQLStatementParser2 extends SQLParser {
    ...
    public SQLStatementParser2(String sql){
        this(sql, null);
    }

    public SQLStatementParser2(String sql, DbType dbType){
        this(new SQLExprParser(sql, dbType));
    }

    public SQLStatementParser2(SQLExprParser exprParser){
        super(exprParser.getLexer(), exprParser.getDbType());
        this.exprParser = exprParser;
        this.dbType = exprParser.dbType;
    }

    protected SQLStatementParser2(Lexer lexer, DbType dbType){
        super(lexer, dbType);
    }
