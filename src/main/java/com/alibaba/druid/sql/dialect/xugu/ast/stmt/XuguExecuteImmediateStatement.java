 ...
 * @description:
 * @author: Roger
 * @create: 2020-10-28 11:18
 **/

public class XuguExecuteImmediateStatement extends XuguStatementImpl {
    ...
    public XuguExecuteImmediateStatement(){
    }

    public XuguExecuteImmediateStatement(String dynamicSql){
...
//            acceptChild(visitor, label);
    ...
    @Override
    public XuguExecuteImmediateStatement clone() {
        XuguExecuteImmediateStatement x = new XuguExecuteImmediateStatement();
