...
public class XuguMultiInsertStatement extends XuguStatementImpl {
    ...
    public static interface Entry extends XuguSQLObject {

    }

    public static class ConditionalInsertClause extends XuguSQLObjectImpl implements Entry {
    ...
    public static class ConditionalInsertClauseItem extends XuguSQLObjectImpl {
    ...
    public static class InsertIntoClause extends SQLInsertInto implements XuguSQLObject, Entry {
