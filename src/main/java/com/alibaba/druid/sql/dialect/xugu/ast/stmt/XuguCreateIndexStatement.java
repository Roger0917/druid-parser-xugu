...
public class XuguCreateIndexStatement extends SQLCreateIndexStatement implements XuguDDLStatement, XuguSegmentAttributes, SQLCreateStatement {
    ...
    public XuguCreateIndexStatement() {
        super (DbType.xugu);
    }
