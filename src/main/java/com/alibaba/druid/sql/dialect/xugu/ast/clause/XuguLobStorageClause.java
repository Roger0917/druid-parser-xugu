...
import com.alibaba.druid.sql.dialect.xugu.ast.XuguSegmentAttributesImpl;
 ...
 * @description:
 * @author: Roger
 * @create: 2020-10-27 13:38
 **/

public class XuguLobStorageClause extends XuguSegmentAttributesImpl implements XuguSQLObject {
    ...
    public void cloneTo(XuguLobStorageClause x) {
        super.cloneTo(x);
    ...
    @Override
    public XuguLobStorageClause clone() {
        XuguLobStorageClause x = new XuguLobStorageClause();
        cloneTo(x);
        return x;
    }
