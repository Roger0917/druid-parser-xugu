...
public class XuguOuterExpr extends SQLExprImpl implements XuguExpr, SQLReplaceable {

    private SQLExpr expr;

    public XuguOuterExpr(){

    }

    public XuguOuterExpr(SQLExpr expr){

        this.expr = expr;
    }

    public XuguOuterExpr clone() {
        XuguOuterExpr x = new XuguOuterExpr();
        if (expr != null) {
    ...
    public boolean equals(Object obj) {
        ...
        XuguOuterExpr other = (XuguOuterExpr) obj;
        if (expr == null) {
            if (other.expr != null) {
                return false;
            }
