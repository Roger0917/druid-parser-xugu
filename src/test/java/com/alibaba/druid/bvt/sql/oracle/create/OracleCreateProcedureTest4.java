...
public class OracleCreateProcedureTest4 extends OracleTest {
    ...
    public void test_0() throws Exception {
        ...
        String sql2="CREATE OR REPLACE FUNCTION fun1(name varchar(20))RETURN INT as\n" +
                "                BEGIN\n" +
                "                send_msg('a');\n" +
                "                END;";
        final DbType dbType = JdbcConstants.ORACLE;
        List<SQLStatement> stmtList = SQLUtils.parseStatements(sql2, dbType);
        SQLCreateFunctionStatement sqlCreateFunctionStatement = (SQLCreateFunctionStatement) stmtList.get(0);
        System.out.println("-----------------------------");
        System.out.println(sqlCreateFunctionStatement.getParameters());
