...
public class OracleCreatePackage extends TestCase {
    ...
    public void test(){
        ...
        for(SQLStatement sqlStatement:createPackageStatementList.get(0).getStatements()){
            for(SQLStatement sqlStatement1:createPackageStatementList.get(1).getStatements()){
                if(sqlStatement1.toString().contains(sqlStatement.toString())){
                    System.out.println("包头过程或函数------");
                    System.out.println(sqlStatement.toString());
                    System.out.println("包体对应过程或函数----");
