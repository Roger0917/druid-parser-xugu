...
public class SysPack2 extends TestPSCache {
    
    public void test(){
        StringBuilder builder = new StringBuilder();
        String sql1= "CREATE OR REPLACE PACKAGE SYSDBA.DBMS_DBA \n" +
                "IS\n" +
        ...
        String sql4 = "CREATE OR REPLACE PACKAGE SYSDBA.DBMS_TEST \n" +
                "IS\n" +
        ...
        String sql5 = "CREATE OR REPLACE PACKAGE SYSDBA.DBMS_STAT\n" +
                "IS\n" +
        ...
        String sql6 = "CREATE OR REPLACE  PACKAGE SYSDBA.DBMS_IMPORT\n" +
                "IS\n" +
                ...
                "END SYSDBA.DBMS_TEST;";
        String sql7 = "CREATE OR REPLACE PACKAGE SYSDBA.DBMS_SCHEDULER \n" +
                "AUTHID CURRENT_USER\n" +
                "IS\n" +
        ...
        String sql8 = "CREATE OR REPLACE PACKAGE SYSDBA.DBMS_SQL\n" +
                "AUTHID CURRENT_USER\n" +
                "IS\n" +
                "\t  --参数描述信息结构 \n" +
                ...
                "END  SYSDBA.DBMS_SQL;";
        String sql9 = "CREATE OR REPLACE PACKAGE  \"SYSDBA\".\"CTX_DOC\"\n" +
                "AUTHID CURRENT_USER\n" +
                "COMMENT '全文检索支持包'  \n" +
                "IS\n" +
                ...
                "                    restab         IN OUT TOKEN_TAB);\n" +
                "END  \"SYSDBA\".\"CTX_DOC\";";
        String sql10 = "CREATE OR REPLACE PACKAGE SYSDBA.DBMS_LOB \n" +
                "IS\n" +
                ...
                "END SYSDBA.DBMS_LOB;";
        String sql11 = "CREATE PACKAGE SYSDBA.UTL_RAW\n" +
                "IS    \n" +
                ...
                "END SYSDBA.UTL_RAW;";
        String sql12 = "CREATE OR REPLACE PACKAGE SYSDBA.DBMS_REPLICATION\n" +
                "IS    \n" +
        ...
        String sql13 = "CREATE OR REPLACE PACKAGE SYSDBA.DBMS_CRYPTO IS\n" +
                "    -- hash算法\n" +
                "    HASH_MD4  INTEGER :=     1;\n" +
                "    HASH_MD5  INTEGER :=     2;\n" +
                "    HASH_SH1  INTEGER :=     3;\n" +
        ...
        String sql14 = "CREATE OR REPLACE PACKAGE  \"SYSDBA\".\"DBMS_BACKUP\"\n" +
                "COMMENT '备份应用程序包'  \n" +
                "IS\n" +
                "  /**\n" +
                "    参数:\n" +
        ...
        for(SQLStatement statement:statementList){
            if (statement instanceof XuguCreatePackageStatement){
                XuguCreatePackageStatement createPackageStatement = (XuguCreatePackageStatement) statement;
                createPackageStatementList.add(createPackageStatement);
            }
        }
